...
echo "  Super+Alt+H     - Tile all windows"
echo "  Super+Shift+H   - Tile focused window"
echo "  Super+Alt+R     - Reset all windows"
echo "  Super+,         - Focus window left"
echo "  Super+.         - Focus window right"
echo "============================================"
